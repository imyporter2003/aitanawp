 ...
 */
const ADAM_API_URL = ''; // e.g. 'https://your-api.vercel.app'
...
(function () {
    ...
    async function performChat(text) {
        ...
        try {
            if (!ADAM_API_URL) {
                // Demo mode – simulate a delay then give a canned response
      ...
      <div id="adam-popup" role="dialog" aria-label="A.D.A.M chat window" aria-hidden="true">
        ...
        <div class="adam-header">
          <div class="adam-header-left">
            ...
            <div>
              <div class="adam-header-name">
                A.D.A.M
                <span class="adam-online-dot" title="Online"></span>
              </div>
        ...
        <div class="adam-input-area">
          <input
            ...
            class="adam-input"
            id="adam-input"
            placeholder="Ask A.D.A.M anything…"
            autocomplete="off"
            maxlength="500"
          />
    ...
    /* ─── Bind events ────────────────────────────────────────────────────────── */
    function bindEvents() {
        const trigger = el('adam-widget-trigger');
        const fab = el('adam-fab');
